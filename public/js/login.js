document.addEventListener("DOMContentLoaded", function () {
    ...
    function clearMessages() {
        const existingMessages =
            document.querySelectorAll(".alert.text-center");
    ...
    document
        ...
        .addEventListener("submit", function (event) {
            ...
            if (newPassword === "Ferre01@") {
                document.getElementById("passwordError").textContent =
                    "No se puede utilizar la contraseña genérica.";
    ...
    $("#passwordModal").on("shown.bs.modal", function () {
        ...
        if (
            ...
            passwordInput.addEventListener("input", function () {
                ...
                const requirementsList = Object.keys(requirementsMet).map(
                    function (key) {
                        ...
                        switch (key) {
                            ...
                            case "caracterEspecial":
                                translatedKey = `
                                    Carácter especial
                                    <div style="font-size: 10px; color: gray; margin-left: 24px;">
                                        (@ $ ! % * ? & + - ~ _ #)
                                    </div>`;
                                break;
                            case "numero":
                ...
                passwordRequirements.innerHTML = `
                    ...
                    <ul style="list-style-type: none;">${requirementsList.join(
                        ""
                    )}</ul>
                `;
            });
